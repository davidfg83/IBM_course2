...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    max = 10000,
                                    step = 1000,
                                    marks = {int(i): str(int(i)) for i in range(0, 10001, 2500)},
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        #Filter only successful launches and count by launch site
        ...
        success_vs_failure['class'] = success_vs_failure['class'].map({1: 'Success', 0: 'Failure'})
